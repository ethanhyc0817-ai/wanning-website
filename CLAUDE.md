...
- Nav (Sep 2026): 6 top-level links (Surf Pool, Golf, Accommodation, Packages, Getting Here,
  + Plan Your Trip ▾ / Explore ▾ / Private Buyout / Book Now). The nav is copied into every
  page (34 files) — change it with a script, not by hand. Mobile menu kicks in ≤1120px; between
  1120–1560px a "compact" rule hides the logo text and tightens gaps because the full nav
  needs ~1500px. Mobile drawer groups Plan Your Trip / Explore in collapsed `<details>`.
